...
BOT_TOKEN = "5712889489:AAETw3obZkyigElTZbCLMGm2-2xVGRc2U0A"
PAYMENT_CHANNEL = "@hddjjsjsjs" #add payment channel here including the '@' sign
OWNER_ID = 5149127304 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@hddjjsjsjs"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
